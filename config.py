...
def load_config():
    ...
    parser.add_argument('--read_port', type=int, default=int(os.getenv(
                        'READ_PORT', 5000)), help='Порт для чтения сообщений')
    parser.add_argument('--send_port', type=int, default=int(
                        os.getenv('SEND_PORT', 5050)), help='Порт для отправки сообщений')
    ...
    parser.add_argument('--nickname', type=str, default=os.getenv('NICKNAME', 'Аноним'), help='Никнейм пользователя')
